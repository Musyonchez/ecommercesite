...
const Navbar = () => {
  ...
  return (
    <>
      <div className=" flex z-50 justify-between items-center pt-3 pl-3 pr-2 pb-1 bg-white fixed w-full">
        <div className=" w-40">
         <Link href="/">
         <Image
            src={logo}
        ...
        <div className=" hidden md:flex">
          <ul className=" flex space-x-5 text-xl">
            <li>New now</li>
            <li className=" hidden lg:flex">Collections</li>
            <li className=" hidden lg:flex">Essentials prices</li>
            <li>Clothing</li>
            <li>Accesories</li>
          </ul>
        </div>
